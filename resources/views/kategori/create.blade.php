<x-app-layout>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('kategori.store') }}" method="POST" data-disable-on-submit>
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select id="nama_kategori" name="nama_kategori" class="form-select @error('nama_kategori') is-invalid @enderror" required>
                        ...
                        <option value="Fiksi" @selected(old('nama_kategori') === 'Fiksi')>Fiksi</option>
                        <option value="Nonfiksi" @selected(old('nama_kategori') === 'Nonfiksi')>Nonfiksi</option>
                    </select>
                    @error('nama_kategori')
